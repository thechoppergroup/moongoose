...
module.exports = {
    ...
    "change-screen": '<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">    <path d="M326.1 331.2V405H73.6V238.6h81.8v92.6zM73.6 204.1h81.8v22.2H73.6z"/>    <path d="M190.6 152.9H437v147H190.6zm0-39.7H437v25.2H190.6zm-54.8 26.2v-29.9c-33.8 5.7-56.8 33.3-59.1 59.8-.2 2.7 0 5.3 0 7.8v21.4H12v-29.4c3.4-68.6 58.9-118.6 123.9-124.5V11.2L210 75.6l-74.2 63.8zm24.3 54.2l-.6.5v-1zm338.6 142.8c0 3.1.2 6.1 0 9.2-3.5 66.8-46.8 110.9-109.7 116.1V499l-57.5-53.4-18.4-15 18.4-15 57.5-56.9V398c26.9-4 41.7-21.7 44.2-52.5.2-3 .3-5.9.3-9.2v-26.8h65.2v26.9z"/></svg>',
    ...
    "navicon-close": '<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">    <path d="M216 184h223v32H216v-32zm0-96h223v32H216V88zm0 192h223v32H216v-32zm-73-178.5l-1.4 1.2-101 87.8c-3.4 3-5.6 7.4-5.6 12.4s2.2 9.4 5.6 12.4l100.9 87.8 1.7 1.5c1.6 1.1 3.6 1.7 5.6 1.7 5.6 0 10.2-4.8 10.2-10.7V110.4c0-5.9-4.6-10.7-10.2-10.7-2.1 0-4.1.7-5.8 1.8z"/></svg>',
    ...
    "projects": '<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">    <path d="M319.2 330.2H54.5c-9.8 0-17.7-7.9-17.7-17.7v-255c.1-9.8 8-17.7 17.7-17.7h264.6c9.8 0 17.7 7.9 17.7 17.7v255c0 9.8-7.8 17.7-17.6 17.7zm-24.1-218.7L266.6 89c-.8-.8-2.1-1.1-3.2-1.1s-2.4.5-3.2 1.3L156.6 222.1s-40.7-39.1-41.8-40.3c-1.1-1.2-2.6-3.1-4.9-3.1-2.3 0-3.3 1.7-4.6 2.8-.8.9-15.3 16.2-22.5 23.8-.4.4-.7.8-1 1-.7.8-1 1.9-1 2.9s.4 2.2 1 3l1.5 1.4s72.2 69.4 73.4 70.5c1.1 1 2.6 2.6 4.8 2.6s3.8-2.3 4.8-3.2l129.1-165.9c.7-.8 1-1.9 1-3-.2-.9-.5-2.2-1.3-3.1zm68 71.6c.7-.8 1-1.9 1-3-.2-1-.6-2.3-1.3-3.2l-3.7-2.9v14.1l4-5z"/>    <path d="M391.7 79.4c10.4 0 18.8 7.3 18.8 17.7v284.7c0 10.4-8.4 18.8-18.8 18.8H95.8c-10.4 0-17.7-8.4-17.7-18.8V363h294.8V79.4h18.8z"/>    <path d="M460.1 147.7c10.4 0 18.8 7.3 18.8 17.7v284.7c0 10.4-8.4 18.8-18.8 18.8H164.2c-10.4 0-17.7-8.4-17.7-18.8v-18.8h294.8V147.7h18.8z"/></svg>',
    ...
    "stop-screen-share": '<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">    <path d="M327.8 172.9c6 11.2 9.4 24.1 9.4 37.6 0 43.9-35.6 79.5-79.5 79.5-18.2 0-34.8-6.1-48.1-16.3l118.2-100.8zm-70-41.9c-43.9 0-79.5 35.6-79.5 79.5 0 14.3 3.8 27.7 10.4 39.3l118.7-101.3a79.014 79.014 0 0 0-49.6-17.5zm67.6 292.8c-11.2-7.8-25.6-13.7-25.9-20.2-.4-3.2-1.5-40.2-1.5-40.2h-80.2s-1.4 36.9-1.5 40.2c-.5 6.4-14.7 12.4-25.9 20.2-11.2 7.8.8 10.7 25.9 11.2h83.2c24.9-.5 36.9-3.5 25.9-11.2zM458.3 82.3V335c0 5.4-4.7 9.9-10.1 9.9H67.5c-5.5 0-10.1-4.4-10.1-9.9V82.3c0-5.4 4.7-9.9 10.1-9.9h380.4c5.5 0 10.1 4.5 10.4 9.9zm-97.2 128.2c0-57.1-46.2-103.3-103.3-103.3s-103.3 46.2-103.3 103.3 46.2 103.3 103.3 103.3 103.3-46.2 103.3-103.3z"/></svg>',
    ...
    "webcam-new": '<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">    <path d="M425.9 163.8c0-7.8-5.2-11.3-11.7-7.7-23.5 13.3-47 26.7-70.6 39.8-3.8 2.1-5.4 5-5.4 9.4.1 22.5.1 45.1 0 67.5 0 4 1.6 6.7 5.1 8.6 23.4 13.2 46.8 26.5 70.1 39.6 7.2 4 12.4 1.1 12.4-7.2.2-24.9.2-50 .1-74.9v-75.1zm-134.3-23c-37.6.1-159.3-.1-182.4.2-11.3.1-20.2 7.2-22.4 17.6-.9 3.6-.7 7.7-.7 11.5v142.1c0 14.8 9.5 24.4 24.2 24.5 30.5.1 61 0 91.5 0v.1H294c14.3 0 24-10 24-24.3V166.8c.1-16.9-9.4-26-26.4-26zM416 38.7V0h-43v38.7h-38.6v43H373v38.6h43V81.7h38.7v-43H416z"/></svg>',
